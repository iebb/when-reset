/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cd671968b5553fb34a3fb58e86f461cc)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REGISTRATION_ACCESS_KEY" | "CREDENTIAL_ENCRYPTION_KEY">> {}
}
declare module "*.p8" {
	const value: string;
