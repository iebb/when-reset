/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e80799fe6e1b418d7bbd326330cc0529)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REGISTRATION_ACCESS_KEY">> {}
}
declare module "*.p8" {
	const value: string;
